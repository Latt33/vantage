          ...
          return (
            <div
              ...
              style={{
                ...
                bottom: 12,
                background: color,
                borderTop: `${w.kind === "good" ? 2 : 1}px solid ${border}`,
                borderBottom: `${w.kind === "good" ? 2 : 1}px solid ${border}`,
                boxShadow: w.kind === "good" ? "0 0 6px rgba(80, 200, 110, 0.55) inset" : undefined,
                pointerEvents: "none",
                overflow: "hidden",
              }}
            >
